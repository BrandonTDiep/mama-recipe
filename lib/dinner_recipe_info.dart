...
class _DinnerRecipeInfoPageState extends State<DinnerRecipeInfoPage> {
  ...
  void _loadFavoriteState() async{
    FirebaseFirestore.instance.collection("users").doc(currentUser?.uid)
        ...
        .where("time", isEqualTo: widget.dinnerRecipe['time'])
        .where("servings", isEqualTo: widget.dinnerRecipe['servings'])
        .where("ingredients", isEqualTo: widget.dinnerRecipe['ingredients'])
        .where("directions", isEqualTo: widget.dinnerRecipe['directions'])
  ...
  void toggleFavorite(){
    setState(() {
      ...
      if(isFavorite){
        FirebaseFirestore.instance.collection("users").doc(currentUser?.uid)
            .collection('favorites').add(widget.dinnerRecipe)
            .then((value){
        ...
        FirebaseFirestore.instance.collection("users").doc(currentUser?.uid)
            .collection('favorites').where("name", isEqualTo: widget.dinnerRecipe['name']).get()
            .then((value){
